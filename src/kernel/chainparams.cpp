...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        // Stable community nodes bundled with the integrated Scash wallet.
        vSeeds.emplace_back("13.215.178.199:8343");
        vSeeds.emplace_back("99.47.252.128:8343");
        vSeeds.emplace_back("185.16.39.26:21015");
        vSeeds.emplace_back("83.78.96.42:8343");
